...
- **Buffer decay (MKT-042):** Stop buffer starts at 1.75× normal, linearly decays to 1× over 2 hours. Wider stops early (premium rich, noisy), normal later. Config: `buffer_decay_start_mult=1.75`, `buffer_decay_hours=2.0`.
