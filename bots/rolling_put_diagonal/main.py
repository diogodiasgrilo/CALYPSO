...
def _check_disabled_kill_switch():
    ...
    banner = (
        "\n" + "=" * 72 +
        "\n  \u26d4 ROLLING PUT DIAGONAL BOT DISABLED FOR SAFETY \u2014 refusing to start" +
        "\n" + "=" * 72 +
        "\n  Per user directive (2026-04-21), HYDRA is the ONLY bot that runs." +
        "\n" +
        "\n  To re-enable:" +
        "\n    Edit bots/rolling_put_diagonal/main.py" +
...
def main():
    """Main entry point."""
    # Refuse immediately if disabled (before signal handlers / args / config)
    _check_disabled_kill_switch()
