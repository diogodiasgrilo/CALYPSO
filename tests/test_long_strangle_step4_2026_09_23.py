...
class TestTheIVPercentileGate:
    ...
    def test_the_vix_proxy_is_labelled_as_a_proxy_when_it_vetoes(self):
        ...
        # 80 prior days: 64 below today's 14.5 and 16 above → 80th percentile.
        # Length matters — under the 60-day sample floor the gate returns the
        # "unavailable" reason instead, which is a DIFFERENT behaviour tested in
        # tests/test_iv_percentile_sample_floor_2026_09_23.py.
        s._vix_history_for_percentile = lambda: [10.0] * 64 + [20.0] * 16
        e = _entry()
    ...
    def test_a_low_proxy_passes(self):
        s = _strat(ls_cfg={"iv_percentile_filter_enabled": True,
                           "iv_percentile_source": "vix", "iv_percentile_max": 35})
        s.current_vix = 10.0
        # 80 days, all above today's 10.0 → 0th percentile, comfortably under 35.
        s._vix_history_for_percentile = lambda: [12.0 + (i % 5) for i in range(80)]
...
class TestTheVixHistoryIsRealNow:
    ...
    def test_the_gate_now_PASSES_on_genuinely_cheap_vol(self, tmp_path, monkeypatch):
        ...
        s = self._strat_with(tmp_path, monkeypatch,
                             [("2026-05-01 15:59:00", 20.0), ("2026-05-02 15:59:00", 20.1), ("2026-05-03 15:59:00", 20.2), ("2026-05-04 15:59:00", 20.3), ("2026-05-05 15:59:00", 20.4), ("2026-05-06 15:59:00", 20.5), ("2026-05-07 15:59:00", 20.6), ("2026-05-08 15:59:00", 20.7), ("2026-05-09 15:59:00", 20.8), ("2026-05-10 15:59:00", 20.9), ("2026-05-11 15:59:00", 21.0), ("2026-05-12 15:59:00", 21.1), ("2026-05-13 15:59:00", 21.2), ("2026-05-14 15:59:00", 21.3), ("2026-05-15 15:59:00", 21.4), ("2026-05-16 15:59:00", 21.5), ("2026-05-17 15:59:00", 21.6), ("2026-05-18 15:59:00", 21.7), ("2026-05-19 15:59:00", 21.8), ("2026-05-20 15:59:00", 21.9), ("2026-05-21 15:59:00", 22.0), ("2026-05-22 15:59:00", 22.1), ("2026-05-23 15:59:00", 22.2), ("2026-05-24 15:59:00", 22.3), ("2026-05-25 15:59:00", 22.4), ("2026-05-26 15:59:00", 22.5), ("2026-05-27 15:59:00", 22.6), ("2026-05-28 15:59:00", 22.7), ("2026-05-29 15:59:00", 22.8), ("2026-05-30 15:59:00", 22.9), ("2026-05-31 15:59:00", 23.0), ("2026-06-01 15:59:00", 23.1), ("2026-06-02 15:59:00", 23.2), ("2026-06-03 15:59:00", 23.3), ("2026-06-04 15:59:00", 23.4), ("2026-06-05 15:59:00", 23.5), ("2026-06-06 15:59:00", 23.6), ("2026-06-07 15:59:00", 23.7), ("2026-06-08 15:59:00", 23.8), ("2026-06-09 15:59:00", 23.9), ("2026-06-10 15:59:00", 24.0), ("2026-06-11 15:59:00", 24.1), ("2026-06-12 15:59:00", 24.2), ("2026-06-13 15:59:00", 24.3), ("2026-06-14 15:59:00", 24.4), ("2026-06-15 15:59:00", 24.5), ("2026-06-16 15:59:00", 24.6), ("2026-06-17 15:59:00", 24.7), ("2026-06-18 15:59:00", 24.8), ("2026-06-19 15:59:00", 24.9), ("2026-06-20 15:59:00", 25.0), ("2026-06-21 15:59:00", 25.1), ("2026-06-22 15:59:00", 25.2), ("2026-06-23 15:59:00", 25.3), ("2026-06-24 15:59:00", 25.4), ("2026-06-25 15:59:00", 25.5), ("2026-06-26 15:59:00", 25.6), ("2026-06-27 15:59:00", 25.7), ("2026-06-28 15:59:00", 25.8), ("2026-06-29 15:59:00", 25.9), ("2026-06-30 15:59:00", 26.0), ("2026-07-01 15:59:00", 26.1), ("2026-07-02 15:59:00", 26.2), ("2026-07-03 15:59:00", 26.3), ("2026-07-04 15:59:00", 26.4), ("2026-07-05 15:59:00", 26.5), ("2026-07-06 15:59:00", 26.6), ("2026-07-07 15:59:00", 26.7), ("2026-07-08 15:59:00", 26.8), ("2026-07-09 15:59:00", 26.9), ("2026-07-10 15:59:00", 27.0), ("2026-07-11 15:59:00", 27.1), ("2026-07-12 15:59:00", 27.2), ("2026-07-13 15:59:00", 27.3), ("2026-07-14 15:59:00", 27.4), ("2026-07-15 15:59:00", 27.5), ("2026-07-16 15:59:00", 27.6), ("2026-07-17 15:59:00", 27.7), ("2026-07-18 15:59:00", 27.8), ("2026-07-19 15:59:00", 27.9)],
    ...
    def test_the_gate_VETOES_expensive_vol_and_names_the_proxy(self, tmp_path, monkeypatch):
        s = self._strat_with(tmp_path, monkeypatch,
                             [("2026-05-01 15:59:00", 10.0), ("2026-05-02 15:59:00", 10.05), ("2026-05-03 15:59:00", 10.1), ("2026-05-04 15:59:00", 10.15), ("2026-05-05 15:59:00", 10.2), ("2026-05-06 15:59:00", 10.25), ("2026-05-07 15:59:00", 10.3), ("2026-05-08 15:59:00", 10.35), ("2026-05-09 15:59:00", 10.4), ("2026-05-10 15:59:00", 10.45), ("2026-05-11 15:59:00", 10.5), ("2026-05-12 15:59:00", 10.55), ("2026-05-13 15:59:00", 10.6), ("2026-05-14 15:59:00", 10.65), ("2026-05-15 15:59:00", 10.7), ("2026-05-16 15:59:00", 10.75), ("2026-05-17 15:59:00", 10.8), ("2026-05-18 15:59:00", 10.85), ("2026-05-19 15:59:00", 10.9), ("2026-05-20 15:59:00", 10.95), ("2026-05-21 15:59:00", 11.0), ("2026-05-22 15:59:00", 11.05), ("2026-05-23 15:59:00", 11.1), ("2026-05-24 15:59:00", 11.15), ("2026-05-25 15:59:00", 11.2), ("2026-05-26 15:59:00", 11.25), ("2026-05-27 15:59:00", 11.3), ("2026-05-28 15:59:00", 11.35), ("2026-05-29 15:59:00", 11.4), ("2026-05-30 15:59:00", 11.45), ("2026-05-31 15:59:00", 11.5), ("2026-06-01 15:59:00", 11.55), ("2026-06-02 15:59:00", 11.6), ("2026-06-03 15:59:00", 11.65), ("2026-06-04 15:59:00", 11.7), ("2026-06-05 15:59:00", 11.75), ("2026-06-06 15:59:00", 11.8), ("2026-06-07 15:59:00", 11.85), ("2026-06-08 15:59:00", 11.9), ("2026-06-09 15:59:00", 11.95), ("2026-06-10 15:59:00", 12.0), ("2026-06-11 15:59:00", 12.05), ("2026-06-12 15:59:00", 12.1), ("2026-06-13 15:59:00", 12.15), ("2026-06-14 15:59:00", 12.2), ("2026-06-15 15:59:00", 12.25), ("2026-06-16 15:59:00", 12.3), ("2026-06-17 15:59:00", 12.35), ("2026-06-18 15:59:00", 12.4), ("2026-06-19 15:59:00", 12.45), ("2026-06-20 15:59:00", 12.5), ("2026-06-21 15:59:00", 12.55), ("2026-06-22 15:59:00", 12.6), ("2026-06-23 15:59:00", 12.65), ("2026-06-24 15:59:00", 12.7), ("2026-06-25 15:59:00", 12.75), ("2026-06-26 15:59:00", 12.8), ("2026-06-27 15:59:00", 12.85), ("2026-06-28 15:59:00", 12.9), ("2026-06-29 15:59:00", 12.95), ("2026-06-30 15:59:00", 13.0), ("2026-07-01 15:59:00", 13.05), ("2026-07-02 15:59:00", 13.1), ("2026-07-03 15:59:00", 13.15), ("2026-07-04 15:59:00", 13.2), ("2026-07-05 15:59:00", 13.25), ("2026-07-06 15:59:00", 13.3), ("2026-07-07 15:59:00", 13.35), ("2026-07-08 15:59:00", 13.4), ("2026-07-09 15:59:00", 13.45), ("2026-07-10 15:59:00", 13.5), ("2026-07-11 15:59:00", 13.55), ("2026-07-12 15:59:00", 13.6), ("2026-07-13 15:59:00", 13.65), ("2026-07-14 15:59:00", 13.7), ("2026-07-15 15:59:00", 13.75), ("2026-07-16 15:59:00", 13.8), ("2026-07-17 15:59:00", 13.85), ("2026-07-18 15:59:00", 13.9), ("2026-07-19 15:59:00", 13.95)],
                             iv_percentile_filter_enabled=True,
                             iv_percentile_source="vix", iv_percentile_max=35.0)
