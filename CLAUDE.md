...
- **Conditional Entry Triggers (Upday-035 + Downday-035):** E6 at 14:00 fires based on intraday SPX direction from session open:
  ...
  - Base entries E1-E3 are NOT affected by the conditional — they always attempt full ICs (or call-only via base-downday `base_entry_downday_callonly_pct: 0.0057`).
