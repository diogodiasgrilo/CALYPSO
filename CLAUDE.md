...
### MEIC-TF Bot Details (v1.1.5 - Updated 2026-02-12)
...
11. **MEIC-TF bot:** Running in LIVE mode (v1.1.9, deployed 2026-02-12) - ONLY active trading bot - adds EMA 20/40 trend filter + credit gate (MKT-011) + hybrid trend-respecting logic + proper P&L tracking (Fix #46/#47) + accurate log labels (Fix #49) + same-strike overlap prevention (Fix #50/MKT-013) + liquidity re-check after overlap adjustment (MKT-014) + Google Sheets timeout protection (Fix #64) + recovery entry classification fix (Fix #65)
