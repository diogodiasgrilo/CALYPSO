...
- **VIX-Scaled Spread Width (MKT-027):** Continuous formula `round(VIX × 5.3 / 5) × 5`, floor 25pt, cap 83pt. Pushes long legs further OTM on high-VIX days → cheaper longs → higher net credit → more stop cushion. Config: `call_min_spread_width=25`, `put_min_spread_width=25`, `max_spread_width=83`, `spread_vix_multiplier=5.3`.
