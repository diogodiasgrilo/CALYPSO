...
- **VIX-Scaled Spread Width (MKT-027):** Continuous formula `round(VIX × 3.5 / 5) × 5`, floor 25pt, cap 100pt. Validated over 619 real-Greeks days: Sharpe +0.405, P&L +$18,712 vs fixed 50pt. Pushes long legs further OTM on high-VIX days → cheaper longs → higher net credit → more stop cushion. Config: `call_min_spread_width=25`, `put_min_spread_width=25`, `max_spread_width=100`, `spread_vix_multiplier=3.5`.
