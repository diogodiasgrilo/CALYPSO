...
### MEIC-TF Bot Details (v1.4.1 - Updated 2026-02-27)
- **Strategy:** MEIC + Trend Following Hybrid (EMA 20/40 direction filter)
- **Structure:** 5 entries per day (10:05, 10:35, 11:05, 11:35, 12:05) — always full iron condors + credit gate
...
- **Wider Starting OTM (MKT-024):** Both sides start at 2× the VIX-adjusted OTM distance. MKT-020/022 scan inward from there to find the widest viable strike. Gives puts more breathing room on volatile days.
...
- **Stop Formula:** Full IC stop = total_credit per side (original Tammy Chambless MEIC rule). MKT-019 (2× max credit) removed in v1.4.0 — MKT-020/022 tightening reduced skew to 1-2x making it unnecessary.
