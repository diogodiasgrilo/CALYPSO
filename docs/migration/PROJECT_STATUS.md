...
> - **Now = Gate 2 paper-smoke watch:** observe A/B/C + the broker through the session + overnight + tomorrow's morning re-auth gate + entry windows before flipping to live-paper or merging.
